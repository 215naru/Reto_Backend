...
const initDB = () => {
  ...
  db.run("CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, price INT, category TEXT, description TEXT, image TEXT, stock INT)");
};
